...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ePustakstorefront/electronics/en",
						"https://electronics.local:9002/ePustakstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ePustakstorefront/electronics/en",
						"https://electronics.local:9002/ePustakstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ePustakstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ePustakstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ePustakstorefront/electronics/en",
						"https://electronics.local:9002/ePustakstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ePustakstorefront",
						"https://electronics.local:9002/ePustakstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ePustakstorefront",
						"https://electronics.local:9002/ePustakstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ePustakstorefront/electronics/en",
						"https://electronics.local:9002/ePustakstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
