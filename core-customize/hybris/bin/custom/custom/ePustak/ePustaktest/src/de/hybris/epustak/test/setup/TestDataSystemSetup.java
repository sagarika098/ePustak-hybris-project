 ...
 */
package de.hybris.epustak.test.setup;
...
import de.hybris.epustak.test.constants.EPustakTestConstants;
import de.hybris.epustak.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = EPustakTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ePustaktest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ePustaktest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ePustaktest/import/cstickets.impex");
			...
			importImpexFile(context, "/ePustaktest/import/csquotes.impex");
		}
	}
}
