 ...
 */
package de.hybris.epustak.core.constants;

/**
 * Global class for all EPustakCore constants. You can add global constants for your extension into this class.
 */
public final class EPustakCoreConstants extends GeneratedEPustakCoreConstants
{
	public static final String EXTENSIONNAME = "ePustakcore";


	private EPustakCoreConstants()
	{
		//empty
	}
