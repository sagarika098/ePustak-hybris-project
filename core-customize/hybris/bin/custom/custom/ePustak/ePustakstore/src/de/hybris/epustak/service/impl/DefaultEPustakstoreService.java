...
public class DefaultEPustakstoreService implements EPustakstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEPustakstoreService.class);
	...
	{
		return DefaultEPustakstoreService.class.getResourceAsStream("/ePustakstore/sap-hybris-platform.png");
	}
