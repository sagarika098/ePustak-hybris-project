 ...
 */
package de.hybris.epustak.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(EPustakFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EPustakFulfilmentProcessConstants.PARENT_PROCESS);
