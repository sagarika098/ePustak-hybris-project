 ...
 */
package de.hybris.epustak.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, EPustakFulfilmentProcessConstants.PARENT_PROCESS);
