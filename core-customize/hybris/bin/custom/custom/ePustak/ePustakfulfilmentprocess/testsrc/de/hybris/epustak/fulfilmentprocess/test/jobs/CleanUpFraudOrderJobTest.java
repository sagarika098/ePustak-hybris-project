 ...
 */
package de.hybris.epustak.fulfilmentprocess.test.jobs;
...
import de.hybris.epustak.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = EPustakFulfilmentProcessConstants.ORDER_PROCESS_NAME;
